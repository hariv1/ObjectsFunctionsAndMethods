...
def turtle5():
    jojo = rg.SimpleTurtle('square')
    jojo.pen = rg.Pen('green', 20)
    jojo.paint_bucket = rg.PaintBucket('blue')

    jose = rg.SimpleTurtle('triangle')
    jose.pen = rg.Pen('red', 5)
    ...
    jose.backward(100)
    jose.draw_regular_polygon(5,50)
